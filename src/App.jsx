    ...
    <div className={`app-shell ${navOpen ? 'nav-open' : ''}`}>
      ...
      <div className="app-body">
        ...
        <main className="app-main">
          ...
          {tab === 'reports' && <Reports accounts={accounts} entries={entries} invoices={invoices} bills={bills} creditNotes={creditNotes} debitNotes={debitNotes} items={items} customers={customers} vendors={vendors} org={org} />}
          {tab === 'settings' && (
            <Settings
              orgId={org.id}
              org={org}
